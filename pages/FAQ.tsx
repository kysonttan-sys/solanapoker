    ...
    <div className="max-w-4xl mx-auto space-y-8 animate-in fade-in duration-500 pb-12">
      ...
      <div className="space-y-4">
          ...
          <FAQItem 
            ...
            answer="We charge a standard rake on Cash Games (typically 3-5%, capped) and an entry fee on Tournaments (5-10%). These fees are redistributed back to the community via Host-to-Earn rewards, Referrals, and the Monthly Jackpot."
          />
          <FAQItem 
