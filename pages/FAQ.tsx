    ...
    <div className="max-w-4xl mx-auto space-y-8 animate-in fade-in duration-500 pb-12">
      ...
      <div className="space-y-4">
          ...
          <FAQItem 
            ...
            answer="We charge a standard rake on Cash Games (typically 3-5%, capped) and an entry fee on Tournaments (5-10%). However, unlike other sites, these fees are redistributed back to the community via Host-to-Earn rewards, Referrals, and Staking yield."
          />
          <FAQItem 
            question="How does Host-to-Earn work?" 
            answer="Any user can create (host) a cash game table or tournament. As the creator, you earn a percentage (30% - 40%) of all rake or fees generated by that table. This incentivizes players to run their own communities within the platform."
          />
          <FAQItem 
            question="What is the $SPX Token?" 
            answer="$SPX is the utility and governance token of the platform. You can stake $SPX to earn a share of platform revenue. The protocol also uses 10% of all revenue to buy back and burn $SPX, making it deflationary."
          />
          <FAQItem 
