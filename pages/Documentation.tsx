...
import { PROTOCOL_FEE_SPLIT, VIP_LEVELS, REFERRAL_TIERS, PRIZE_POOL_INFO } from '../constants';
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-8 animate-in fade-in duration-500 pb-12">
            ...
            <div className="flex-1 space-y-16">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="p-4 rounded-xl bg-gradient-to-br from-sol-purple/10 to-transparent border border-sol-purple/20">
                                    <div className="flex justify-between mb-2">
                                        <span className="text-sol-purple font-bold">Referral Overrides</span>
                                        <span className="text-white font-mono">Up to 60%</span>
                                    </div>
                                    <p className="text-xs text-gray-400">Distributed to upline network via Hybrid Override Model.</p>
                                </div>
                                ...
                                <div className="p-4 rounded-xl bg-gradient-to-br from-blue-500/10 to-transparent border border-blue-500/20">
                                    ...
                                    <p className="text-xs text-gray-400">Distributed weekly to Masters based on team rake.</p>
                                </div>
                ...
                <section id="ecosystem" className="scroll-mt-32">
                    <h2 className="text-2xl font-bold text-white mb-6 flex items-center gap-2">
                        <Network className="text-sol-purple"/> Earn: Referrals
                    </h2>
                    <Card className="bg-sol-dark/60 space-y-8">
                        <div>
                            ...
                            <ul className="list-disc list-inside space-y-2 text-sm text-gray-400 mb-6">
                                <li><strong className="text-white">Direct Upline (Level 1):</strong> Gets their FULL rank % (e.g., Master gets full 60%)</li>
                                <li><strong className="text-white">Indirect Uplines (Level 2+):</strong> Get override difference (e.g., 60% - 50% = 10%)</li>
                                <li><strong className="text-white">No Self-Earning:</strong> You earn $0 from your own play, only from downline activity</li>
                                <li><strong className="text-white">Unlimited Chain Depth:</strong> Everyone in your upline earns their override</li>
                            </ul>

                            <div className="bg-gray-800 p-4 rounded-lg mb-6">
                                <h4 className="text-white font-bold mb-3">Rank System</h4>
                            ...
                            <div className="bg-sol-purple/10 border border-sol-purple/20 p-4 rounded-lg">
                                <h4 className="text-sol-purple font-bold text-sm mb-2">Example Calculation</h4>
                                <p className="text-xs text-gray-400">
                                    If a FREE player generates $100 rake and their upline chain is FREE → AGENT (20%) → BROKER (35%) → MASTER (60%):
                                </p>
                                <ul className="text-xs text-gray-300 mt-2 space-y-1">
                                    <li>• Level 1 (AGENT): Gets full 20% = $20</li>
                                    <li>• Level 2 (BROKER): Gets 35% - 20% = 15% = $15</li>
                                    <li>• Level 3 (MASTER): Gets 60% - 35% = 25% = $25</li>
                                    <li className="text-sol-green font-bold">→ Total distributed: $60 (60% of rake)</li>
                                </ul>
                            </div>
                        </div>
                    </Card>
